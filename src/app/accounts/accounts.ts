          ...
          <div class="column-layout group_2">
            <div class="row-layout header">
              ...
              <div class="row-layout buttons">
                ...
                <igc-button @click=${() => this.newAccountDialog?.toggle()} class="user-input">
                  <span class="material-icons">
                    business
                  </span>
            ...
            <div class="row-layout filters-and-sorting">
              ...
              <div class="row-layout group_5">
                <igc-button variant="flat" @click=${() => this.dropdown?.toggle(this.button)} id="button" class="user-input user-input_5">
